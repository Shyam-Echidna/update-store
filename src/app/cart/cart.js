...
function CartController($q, Orders, Order, LineItems, $rootScope, toastr, LineItemHelpers, LineItemsList) {
    var vm = this;
    vm.order = Order;
        ...
        Orders.Get(vm.order.ID)
            ...
            function line(){
                var dfd = $q.defer();
                    ...
                    line().then(function(data){
                     vm.lineItems = data;
                    })
    });
}

function MiniCartController($q, $rootScope, LineItems, CurrentOrder, LineItemHelpers) {
    var vm = this;
    vm.LineItems = {};
    vm.Order = null;
                ...
                $q.all(queue)
                    .then(function(results) {
                        angular.forEach(results, function(result) {
                            ...
                            console.log("12345678",vm.LineItems.Items);
                        });
